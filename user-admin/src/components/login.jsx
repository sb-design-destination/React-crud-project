...
function ToggleThemeHomeIcon(props) {
   ...
   return (currentTheme === 'light') ? <img src="https://cdn-icons-png.flaticon.com/512/25/25694.png" className='homeicon' alt="" /> : <img src="https://as1.ftcdn.net/v2/jpg/03/66/63/52/1000_F_366635261_pwhef2O15F1s3QLGs756583nhNZgNGg3.jpg" className='homeicon' alt="" />
...
let LoginPage = (props) => {
   ...
   console.log(props);
   return (<>
      <div className="main-box" style={{ marginTop: '50px' }}>
